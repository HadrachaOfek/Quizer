...
import tmpFile from "../assets/template.xlsx";
    ...
    >
      <Grid container spacing={2}>
        ...
        <Grid item xs={12} md={3}>
          <Stack spacing={2}>
            ...
            <Box sx={{ display: "grid", gridTemplateColumns: "5fr 1fr" }}>
              ...
              <Tooltip title="הורדת תבנית">
                <IconButton>
                  <a variant="contained" href={tmpFile} download={true}>
            ...
            <Box sx={{ display: "flex" }}>
              <Box sx={{ width: "100%" }}>
                <Typography variant="h2" align="center" color={"gray"}>
                  {Math.floor(average)}
                </Typography>
                <Typography
                  variant="body1"
        ...
        <Grid item xs={12} md={9}>
          {load ? (
            ...
            <Stack spacing={1} sx={{ overflowY: "scroll", minHeight: "90%" }}>
              {[...examineesMap.values()].map((element) => (
                <Paper
                  ...
                  key={element.userId}
                >
                  <Typography variant="h5">{element.firstName}</Typography>
                  <Typography variant="h5">{element.lastName}</Typography>
                  <Typography variant="h5">{element.userId}</Typography>
                  <Typography variant="h5">
                    {element.grade ? Math.round(element.grade) : ""}
                  </Typography>
                  <Box>
      ...
      >
        ...
        <Stack direction="row" justifyContent="space-between">
          <Button variant="outlined" onClick={(e) => createSheet()}>
            <Typography>הורדת גליון ציונים</Typography> <DownloadIcon />
          </Button>
          <Tooltip title="מחק קבוצה">
            <IconButton onClick={(e) => deleteGroup(groupName)}>
              <DeleteIcon />
            </IconButton>
          </Tooltip>
        </Stack>
